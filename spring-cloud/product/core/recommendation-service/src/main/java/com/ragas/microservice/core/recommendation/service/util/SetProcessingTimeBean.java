 ...
 * 
 */
package com.ragas.microservice.core.recommendation.service.util;
 ...
 */
@Component
public class SetProcessingTimeBean {
	private static final Logger LOG = LoggerFactory.getLogger(SetProcessingTimeBean.class);
